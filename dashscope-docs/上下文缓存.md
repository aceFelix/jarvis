...
千问 Max：qwen3.8-max、qwen3.8-max-preview（仅[Token Plan](https://help.aliyun.com/zh/model-studio/token-plan-overview)可用）、qwen3.7-max、qwen3.7-max-2026-05-20、qwen3.7-max-2026-06-08、qwen3.6-max-preview、qwen3-max
...
-   **文本生成模型**
    ...
    -   千问 Max：qwen3.8-max、qwen3.8-max-preview（仅[Token Plan](https://help.aliyun.com/zh/model-studio/token-plan-overview)可用）、qwen3.7-max、qwen3.7-max-2026-05-20、qwen3.7-max-2026-06-08、qwen3-max、qwen3-max-preview、qwen-max
