...
![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8527784871/CAEQYhiBgIDE9unxyRkiIDVjNDgwMDBjYTE0NzQ5MTBiMzBiNjJkNTk5ZjE2YTIz4358988_20240409160230.951.svg)
...
-   **文本生成模型**
    ...
    -   千问Max：qwen3.8-max-preview（仅[Token Plan](https://help.aliyun.com/zh/model-studio/token-plan-overview)可用）、Qwen3.7-Max系列、Qwen3.6-Max系列、Qwen3-Max系列、Qwen-Max系列
